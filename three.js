...
function myNumber(){
    ...
    numbers[0]= parseInt(document.getElementById("sideOne").value);
    numbers[1]= parseInt(document.getElementById("sideTwo").value);
    numbers[2]= parseInt(document.getElementById("sideThree").value);
